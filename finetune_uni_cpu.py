...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('finetune_uni_cpu.log'),
...
test_df_path = 'test_imgs_df_portal_tract_separated.csv'
...
finetuned_path = 'finetuned_uni_test_results.pkl'
...
all_results_path = 'all_evaluation_results.pkl'
...
logger.info(f"- Log file: finetune_uni_cpu.log")
logger.info("")
